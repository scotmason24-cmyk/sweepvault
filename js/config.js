...
const SITE_CONFIG = {
  ...
  "clubs.poker":           { name: "Clubs Poker",      aliases: ["ClubsPoker"], selector: ".SwitchCurrenciesContainer__currency_balance", launch_url: "https://play.clubspoker.com/d/?tables/all&_gl=1*1njthbq*_gcl_au*NTc4NzcwOTgxLjE3NzYwNDc0Nzg." },
  ...
  "spinpals.com":          { name: "SpinPals",         aliases: ["Spinpals"], selector: "div.border-deepPurple-300 p.text-white", launch_url: "https://www.spinpals.com/user/reward/daily-bonus" },
  ...
  "dogghousecasino.com":   { name: "Dogghouse",        aliases: ["Dogghouse Casino"], selector: ".MuiBox-root:has(img[src*='sc-icon']) span.MuiTypography-root", launch_url: "https://play.dogghousecasino.com/profile" },
